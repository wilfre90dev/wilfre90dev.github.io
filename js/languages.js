...
function setLanguageWeb(language) {
    switch (language) {
        case 'en':
            ...
            document.cookie = `userlang=en; expires=${new Date(new Date().getTime()+1000*60*60*24*365).toGMTString()}; path=/; domain=.thecodelight.com`;
        ...
        case 'es':
            ...
            document.cookie = `userlang=es; expires=${new Date(new Date().getTime()+1000*60*60*24*365).toGMTString()}; path=/; domain=.thecodelight.com`;
            if (flagEnMobile != null){
